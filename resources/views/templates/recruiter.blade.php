<html>
    <head>
        ...
        <style>
            {!! file_get_contents(asset('assets/css/resumes/recruiter.css')) !!}
        </style>
    </head>
    <body class="resume-pdf  resume-recruiter">
        ...
        <div class="print-paper">
            ...
            <span class="heading heading-bold">Techniques, Software & Instrumentation</span>
            <br/>
